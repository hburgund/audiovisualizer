...
precision highp float;
      ...
      void main() {
          ...
          float baseRippleIntensity = 0.2;
          float rippleScale = 2.0;
          float timeScale = 1.0;

          // Base noise for subtle ripples
          float baseNoise = pnoise(position * rippleScale + vec3(u_time * timeScale), vec3(10.0));
          float displacement = baseRippleIntensity * baseNoise;
